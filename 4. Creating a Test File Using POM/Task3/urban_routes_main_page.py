...
class UrbanRoutesPage:
    ...
    BOOK_BUTTON_LOCATOR = (By.XPATH, '(//*[@id="root"]/div/div[3]/div[4]/button/span[1]')
    CAMPING_LOCATOR = (By.XPATH, '(//*[@id="root"]/div/div[3]/div[3]/div[2]/div[1]/div[2]/div[1]/img')    
    ADD_DRIVER_LICENSE_LOCATOR = (By.XPATH, '(//*[@id="root"]/div/div[1]/div[2]/div[1]/div')
    ...
    ADD_BUTTON_LOCATOR = (By.XPATH, '(//*[@id="root"]/div/div[3]/div[4]/button/span[1]')
    ADD_A_DRIVER_LICENCE_TITLE_LOCATOR = (By.XPATH, '(//div[contains(text(),"Add a driver")]')
    VERIFICATION_TEXT_LOCATOR = (By.XPATH, '(//*[@id="root"]/div/div[1]/div[2]/div[2]/div')
